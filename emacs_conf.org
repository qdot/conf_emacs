...
:END:
I have my emacs configuration file set to tangle itself on save, so I
can just load the output from that when needed.
...
** Email
*** Setup
Conditions under which mail apps and variables should be loaded.
