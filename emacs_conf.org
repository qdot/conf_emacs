...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-x k") 'qdot/kill-this-buffer)
...
** term-mode
#+BEGIN_SRC emacs-lisp
  (defun qdot/turn-on-term-line-mode ()
    (term-line-mode))
  
  (add-hook 'term-mode-hook 'qdot/turn-on-term-line-mode)
#+END_SRC
** lilypond-mode
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key [(control XF86AudioNext)] 'wg-switch-to-workgroup-at-index-5)
  (global-set-key [(control right)] 'sp-forward-slurp-sexp)
  (global-set-key [(control left)] 'sp-forward-barf-sexp)
  (global-set-key [(control meta right)] 'sp-backward-slurp-sexp)
  (global-set-key [(control meta left)] 'sp-backward-barf-sexp)
#+END_SRC
