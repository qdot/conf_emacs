...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path (expand-file-name (concat qdot/emacs-conf-dir "tangle/")))
...
#+BEGIN_SRC emacs-lisp
  (add-hook 'after-init-hook
            `(lambda ()
               ...
               (let* ((file "~/.emacs_files/emacs_conf.org")
                      (exported-file "~/.emacs_files/tangle/emacs_conf.el")
                      (age (lambda (file)
                             (float-time
                 ...
                 (unless (and (file-exists-p exported-file)
                   ...
                   (require 'ob-tangle)
                   (org-babel-tangle-file "~/.emacs_files/emacs_conf.org")))
               (load-file "~/.emacs_files/tangle/emacs_conf.el")
