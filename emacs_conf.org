...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set certain nicks to show join/part on. Ignore all others.
  ;; Doesn't seem to work right. At all.
  
  ;; (setq qdot/bitlbee-status-nicks '("aim-subgirl13" "aim-xiuvx" "aim-bokehcat" "qdot76367" "aim-allenjgmailcom"))
  ...
  (defun qdot/erc-znc-rename-server-buffer ()
    ...
    (save-excursion
      (let ((network-name (symbol-name (erc-network))))
        ...
        (rename-buffer (concat "znc-" network-name))
...
#+begin_src emacs-lisp
  ...
  (add-hook 'js-mode-hook 'qdot/programming-mode-hook)
  (add-hook 'js2-mode-hook 'qdot/programming-mode-hook)
  (add-hook 'js3-mode-hook 'qdot/programming-mode-hook)
...
CLOSED: [2013-05-03 Fri 21:39]
- State "DONE"       from "TODO"       [2013-05-03 Fri 21:39]
** TODO Divide down large configurations into org subnodes
