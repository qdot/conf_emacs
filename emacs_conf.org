...
#+BEGIN_SRC emacs-lisp
  ...
  ;;        (custom-set-faces
  ;;         '(mode-line ((t (:box nil))))
  ;;         '(powerline-active1 ((t (:inherit mode-line :background "#444444"))) t)
  ;;         '(powerline-active2 ((t (:inherit mode-line :background "#666666"))) t)))
#+END_SRC
** qdot-funcs
#+BEGIN_SRC emacs-lisp
  (require 'qdot-funcs)
...
** TODO Set up local el-get recipes directory so we don't have to track el-get perfectly
