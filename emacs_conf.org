...
** TODO Think about non-fixed width for non-code buffers?
...
** TODO Go through commit list for mu, add new functions/actions     :emacs:
** TODO Add new mailbox shortcuts for kelly, receipts, etc...        :emacs:
** TODO Turn on semantic in C++ buffers                              :emacs:
** TODO Turn on flyspell in buffers that need it
** TODO Load mu4e-unread-main as part of startup
