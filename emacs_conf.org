...
*** cedet                                                         :package:
:PROPERTIES:
:ID:       322ab735-8edc-448a-8262-9d6f99b58b87
:END:
...
#+BEGIN_SRC emacs-lisp
  (use-package dxr
      :load-path "~/.emacs_files/dev-packages/dxr.el/"
...
#+BEGIN_SRC emacs-lisp
  (use-package projectile
      ...
      (projectile-register-project-type 'gecko
                                        '("mach" "moz.build")
                                        "NO_BUILDSTATUS_MESSAGES=1 python mach --log-no-times build"
...
*** python-mode                                                   :package:
:PROPERTIES:
:ID:       f441c829-0494-4021-9709-16b26e58c2b8
:END:
#+BEGIN_SRC emacs-lisp
