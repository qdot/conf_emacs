;;; asciidoc-mode.el --- a major-mode for highlighting a hierarchy structured text.
...
;;
;; To enter asciidoc-mode automatically, add (autoload 'asciidoc-mode "asciidoc-mode")
...
;; the docstring for the asciidoc-mode function.
;;
...
(defvar asciidoc-title-1 'asciidoc-title-1-face)
(defvar asciidoc-title-2 'asciidoc-title-2-face)
(defvar asciidoc-title-3 'asciidoc-title-3-face)
(defvar asciidoc-title-4 'asciidoc-title-4-face)
...
(defconst asciidoc-font-lock-keywords
  (eval-when-compile
    (list
     ...
     ;; Section titles
     (cons "^==? +.*"		'asciidoc-title-1)
     (cons "^=== +.*"		'asciidoc-title-2)
     (cons "^==== +.*"		'asciidoc-title-3)
     (cons "^===== +.*"		'asciidoc-title-4)
...
;;###autoload
(define-derived-mode asciidoc-mode text-mode "DOC"
  "Major mode for editing AsciiDoc text files.
Turning on Doc mode runs the normal hook `asciidoc-mode-hook'.
