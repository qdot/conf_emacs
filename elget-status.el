((ace-jump-mode status "installed" recipe
 ...
 (buffer-timer status "installed" recipe
               (:name buffer-timer :website "http://github.com/hardaker/elisp-buffer-timer/" :description "Creates tables showing amount of time spent in buffers and buffer groups" :type github :pkgname "hardaker/elisp-buffer-timer"))
 ...
 (weather-metno status "installed" recipe
                (:name weather-metno :description "Weather data from met.no in Emacs." :type github :pkgname "ruediger/weather-metno-el"))
